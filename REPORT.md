...
- 事業者の課題として以下の2つがあると推測した。
    ...
    2. 電力の需給を合わせたい
        - 電力供給の観点から考えると、
        - 電力使用量をどの軸で切るかによってクライアントへの見せ方が変わる。
            - 電力供給の観点から考えると以下の要素が重要だと推測する。
                - 季節によって電力の消費量が変わる
                    - 経年変化が見れないと示唆には繋がらなそうであるため、今回のデータセットでは適さないと考える。
                - 時間帯によって電力の消費量が変わる
...
# テーブル定義
- 時間が足りず書面に落としきれませんでした。詳細はmodels配下のモデルクラスをご確認頂けますと幸いです。
## エリアテーブル
